...
def arith_oper():   # 산술 연산자 연습
    ...
    # +, -, *, /
    print(7/3)
    print(6/2)   # 정수를 정수로 나눠도 실수형태로 표현
...
def assignment_ex():    # 치환문
    ...
    a = 1
    print(a, "is", type(a)) # type 함수 -> 데이터 혹은 객체의 데이터 타입을 확인
...
def logical_oper():
    ...
    print(a < b and a != b)  # a < b의 논리값과 a != b의 논리값이 논리곱
    print(a == b or a != b)  # a == b의 논리값과 a != b의 논리값이 논리합

def bit_oper():
    print("===== 비트연산자")
    # 비트 NOT : 1 <-> 0
    print(bin(5), bin(~5))  # ~ : bit not   # 이진수 보수 표기법에 의해 약간의 형태변화가 이루어질 수 있다
