...
def get_datetime():
    ...
    # datetime의 주요 속성들
    print("date 관련속성 : ", dt.year, dt.month, dt.day)
    print("time 관련속성 : ", dt.hour, dt.minute, dt.second, dt.microsecond)
...
def timedelta_ex():
    ...
    # datetime - datetime : timedelta (시간의 간격값)
    diff = current - past
    ...
    # 현재 시간에서 100일 후 정보
    print("current : ", current)
    diff = datetime.timedelta(100, 0, 0)    # 100일의 간격값
