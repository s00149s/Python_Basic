...
def test_select_data(db_file):  # 데이터 불러오기
    # conn = create_connection(db_file)
    with create_connection(db_file) as conn:    # 추천 -> with문 종료 -> 자동으로 close()
        # select 쿼리 수행
